...
public class PayView extends JFrame {
	...
	public PayView() {
		...
		// °æ±âÁ¤º¸, µî±Þ, ¼ö·®, ÁÂ¼®¹øÈ£, °¡°Ý
		Object[][] data = new Object[0][5];
		Object[] columnNames = { "°æ±âÁ¤º¸", "µî±Þ", "ÁÂ¼®¹øÈ£", "¼ö·®", "°¡°Ý" };
		...
		la_email = new JLabel("ÀÌ¸ÞÀÏ");
		la_phone = new JLabel("ÈÞ´ëÆù¹øÈ£");
		...
		rbt_delivery = new JRadioButton("ÀÏ¹Ý ¹è¼Û(2500¿ø)");
		bg1=new ButtonGroup();
		bg1.add(rbt_direct);
		...
		rbt_bank = new JRadioButton("¹«ÅëÀå ÀÔ±Ý");
