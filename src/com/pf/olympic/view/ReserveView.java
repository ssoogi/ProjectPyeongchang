...
public class ReserveView extends JFrame {
	...
	public ReserveView() {
		...
		la_match_name = new JLabel("¹ÙÀÌ¾Ö½½·Ð ³²¼º °èÁÖ 4 x 7.5km");
		la_match_date = new JLabel("2018³â 2¿ù 23ÀÏ(±Ý)");
		...
		la_slash = new JLabel("/");
		la_stadium_name = new JLabel("¾ËÆæ½Ã¾Æ ¹ÙÀÌ¾Ö½½·Ð ¼¾ÅÍ");
		...
		Object[] columnNames = { "ÁÂ¼®µî±Þ", "¼ö·®", "°¡°Ý"};
		...
		la_total_str = new JLabel("ÃÑ ¿¹»ó °áÁ¦ ±Ý¾×     \\");
